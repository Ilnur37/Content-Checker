 ...
 */
package edu.java.scrapper.domain.jooq.generate.tables;
...
import edu.java.scrapper.domain.jooq.generate.tables.records.ChatLinkRecord;
...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    public <O extends Record> ChatLink(Table<O> path, ForeignKey<O, ChatLinkRecord> childPath, InverseForeignKey<O, ChatLinkRecord> parentPath) {
    ...
    public static class ChatLinkPath extends ChatLink implements Path<ChatLinkRecord> {
        ...
        private static final long serialVersionUID = 1L;
        public <O extends Record> ChatLinkPath(Table<O> path, ForeignKey<O, ChatLinkRecord> childPath, InverseForeignKey<O, ChatLinkRecord> parentPath) {
    ...
    public ChatPath chat() {
        if (_chat == null)
            _chat = new ChatPath(this, Keys.CONSTRAINT_8, null);
    ...
    public LinkPath link() {
        if (_link == null)
            _link = new LinkPath(this, Keys.CONSTRAINT_86, null);
