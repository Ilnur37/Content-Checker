...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(1000000000).nullable(false).defaultValue(DSL.field(DSL.raw("''"), SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>LINK.AUTHOR</code>.
     */
    ...
    public List<UniqueKey<LinkRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_URL);
    }

    private transient ChatLinkPath _chatLink;

    /**
     * Get the implicit to-many join path to the <code>PUBLIC.CHAT_LINK</code>
     * table
     */
    public ChatLinkPath chatLink() {
        if (_chatLink == null)
